...
private:
    ...
    void updateSurpecheStats();
    void updateTendanceStats();
    void updateTop5FishStats();  // Update top 5 fish species chart
    
    // Mode édition pour captures
    bool isEditingCapture;
    int currentEditCaptureId;
    ...
    void clearCaptureForm();  // Clear capture form and reset to add mode
