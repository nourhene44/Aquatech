...
private:
    ...
    void handleArduinoBoatEventLine(const QString& line);
    bool assignFreeQuaiToDetectedBoat(int* quaiIdOut, QString* errorOut = nullptr);
    bool releaseAssignedQuai(QString* errorOut = nullptr);
