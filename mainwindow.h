...
private slots:
    ...
    void on_cap_btnAddCaptureLine_clicked();
    void on_cap_btnRemoveCaptureLine_clicked();
    ...
    void on_cap_pushButton_4_clicked();
...
private:
    Ui::MainWindow *ui;
    QWidget* m_previousCapturePage = nullptr;
    ...
    double m_quaiWindCloseThresholdKmh = 10.0;
    ...
    void setupCapturePageVisuals();
    void setupClientPageVisuals();
    ...
    void updateCapturesTemperatureSummaryUi();
    ...
    bool ensureQuaiWeatherStatusSupport(QString* errorOut = nullptr);
